...
NULL) player_pos_drill_style';
    ...
    $joins[] = "left join player_comments on player_comments.team_id = '".$login->team_id()."' and
player_comments.player_id = player.player_id";
    $col[] = "player_comments.player_comments_text";

    $joins[] = "left join team_player on team_player.player_id = player.player_id and team_player.team_id = '".$login->team_id()."'";
